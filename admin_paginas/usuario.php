...
$usuarios = [
    ['nombre' => 'Juan Pérez', 'email' => 'juan.perez@novaris.com', 'rol' => 'Administrador', 'estado' => 'Aprobada'],
    ['nombre' => 'María García', 'email' => 'maria.garcia@novaris.com', 'rol' => 'Solicitante', 'estado' => 'Aprobada'],
    ['nombre' => 'Carlos López', 'email' => 'carlos.lopez@novaris.com', 'rol' => 'Técnico', 'estado' => 'Pendiente'],
    ['nombre' => 'Ana Rodríguez', 'email' => 'ana.rodriguez@novaris.com', 'rol' => 'Solicitante', 'estado' => 'Rechazada'],
];
?>
<!DOCTYPE html>
<html lang="es">
...
<body class="app-page">
    ...
    <div class="side-bar">
        ...
        <div class="reportes-link active">
...
<main class="usuario-info">
    ...
    <?php foreach ($usuarios as $usuario): ?>
        <tr>
            <td><?php echo escaparHTML($usuario['nombre']); ?></td>
            <td><?php echo escaparHTML($usuario['email']); ?></td>
            <td><?php echo escaparHTML($usuario['rol']); ?></td>
            <td><?php echo escaparHTML($usuario['estado']); ?></td>
            <td><button type="button" class="btn btn-primary">Ver perfil</button></td>
        </tr>
    <?php endforeach; ?>
    </tbody></table></div>
</main>
