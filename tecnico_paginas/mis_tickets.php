...
$tickets = [
    ['id' => 18, 'solicitante' => 'Juan Perez', 'titulo' => 'La impresora no responde', 'prioridad' => 'Alta', 'estado' => 'En proceso'],
    ['id' => 17, 'solicitante' => 'Maria Gomez', 'titulo' => 'Problemas con el correo', 'prioridad' => 'Media', 'estado' => 'Pendiente'],
    ['id' => 16, 'solicitante' => 'Lucia Torres', 'titulo' => 'Cambio de teclado', 'prioridad' => 'Baja', 'estado' => 'En proceso'],
];
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Mis tickets - Novaris</title>
...
<body class="app-page">
    ...
    <div class="side-bar">
        ...
        <div class="inventario-link active"><svg fill="none" viewBox="0 0 24 24" stroke-width="1.8"><path d="M20 11.5a7.5 7.5 0 0 1-7.5 7.5H8l-4 2v-5.18A7.5 7.5 0 1 1 20 11.5Z"/><path d="M8.5 10.5h.01M12 10.5h.01M15.5 10.5h.01" stroke-linecap="round"/></svg><a href="mis_tickets.php" class="side-link">Mis tickets</a></div>
    ...
    <div class="informacion"><span id="fechahoy"></span><div id="titulo-informacion"><strong>Bienvenido,</strong> <?php echo escaparHTML($nombreCompleto); ?></div><p>Revisa los tickets activos asignados a tu cuenta.</p></div>
    <main class="help-page"><section class="ticket-list"><h2>Mis tickets</h2><div class="ticket-table-wrapper"><table class="ticket-table"><thead><tr><th>ID</th><th>Solicitante</th><th>Asunto</th><th>Prioridad</th><th>Estado</th></tr></thead><tbody><?php foreach ($tickets as $ticket): ?><tr><td><?php echo (int) $ticket['id']; ?></td><td><?php echo escaparHTML($ticket['solicitante']); ?></td><td><?php echo escaparHTML($ticket['titulo']); ?></td><td><?php echo escaparHTML($ticket['prioridad']); ?></td><td><?php echo escaparHTML($ticket['estado']); ?></td></tr><?php endforeach; ?></tbody></table></div></section></main>
    <script>
